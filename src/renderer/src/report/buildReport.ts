...
export function buildReport(
  ...
  lines.push('# Windows11-WSL2-Cleaner – Storage Report')
  ...
  if (checkRows.length > 0) {
    lines.push('## Cleanable Checks (Windows11-WSL2-Cleaner)')
  ...
  lines.push(
    '**Note for AI analysis:** This is a storage report for a Windows machine running WSL2, generated by the ' +
      '"Windows11-WSL2-Cleaner" tool. Categories whose name ends in "(manual review needed, no automatic check)" are not covered ' +
